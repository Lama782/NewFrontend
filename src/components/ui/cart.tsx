    ...
    return(
        ...
        <PopoverTrigger asChild>
          <div className="flex gap-1">
            ...
            <ShoppingCartIcon className="h-6 w-6 text-gray-800 dark:text-gray-200 transition-transform duration-300 ease-in-out hover:scale-110 hover:text-blue-500 dark:hover:text-blue-400" />
